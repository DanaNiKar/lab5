...
public class Main  {
  ...
  private static Scanner scanner = new Scanner(System.in);
    /** логгер - объект запускающий события в журнале */
  ...
  public static void main(String[] args)  {
    ...
    } catch (InputMismatchException e)  {  /* ловим ошибку, если не число */
  ...
  private static void editTree()  {
    ...
    System.out.print("Необходимо ввести индекс дерева (от 0 до "
        + (forest.size() - 1) + "): ");
    ...
    try  {
      ...
      /* повторное генерирование исключения и связывание в цепочку */
      throw new RuntimeException("Ошибка при редактировании: ", e);
    }
  }
  ...
  private static void displayTrees()  {
    ...
    for (int i = 0; i < forest.size(); i++)  {
      ...
      System.out.println("Зрелое ли дереве: "
          + ((tree.isMature()) ? "Да" : "Нет"));
      System.out.println();
    }
  }
