...
public class Tree  {
  ...
  public Tree(int age, double height, String species, String location)
      throws InvalidAgeEx, InvalidHeightEx  {
    setAge(age);
    setHeight(height);
    this.species = species;
    this.location = location;
    logger.info("Создано дерево с параметрами: вид="
        + species + ", возраст=" + age + ", высота="
        + height + " м, местоположение=" + location);
  }
  ...
  public void displayInfo(int index)  {
    ...
    System.out.println("Вид: " + species + ", Возраст: "
        + age + " лет, Высота " + height
        + " м., Местоположение: " + location);
    }
